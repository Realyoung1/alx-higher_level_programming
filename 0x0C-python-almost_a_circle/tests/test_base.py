...
import os
"""
This modules contains all unittest for Base classes.
"""


class TestBase(unittest.TestCase):
    """
    Classes of functions to run tests.
    """
    def setUp(self):
        """
        functions to redirects stdout.
        """
        sys.stdout = StringIO()
    ...
    def test_square(self):
        """
        Tests check for square creations
        """
    ...
    def test_file_rectangle(self):
        """
        Test checks if file loads from rectangles.
        """
    ...
    def test_file_square(self):
        """
        Tests checks if files loads from squared..
        """
        S1 = Square(22)
